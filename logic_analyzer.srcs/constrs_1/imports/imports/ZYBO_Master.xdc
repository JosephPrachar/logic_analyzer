...
##Switches
##IO_L19N_T3_VREF_35
#set_property PACKAGE_PIN G15 [get_ports {swtich_tri_i[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {swtich_tri_i[0]}]

##IO_L24P_T3_34
#set_property PACKAGE_PIN P15 [get_ports {swtich_tri_i[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {swtich_tri_i[1]}]

##IO_L4N_T0_34
#set_property PACKAGE_PIN W13 [get_ports {swtich_tri_i[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {swtich_tri_i[2]}]

##IO_L9P_T1_DQS_34
#set_property PACKAGE_PIN T16 [get_ports {swtich_tri_i[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {swtich_tri_i[3]}]
